...
<template>
  <fieldset class="card fieldset bg-base-200 border-base-300 rounded-box w-xs ring-2 ring-white/5 shadow-lg/25 shadow-black inset-shadow-sm p-4">
    <div class="card-body size-full items-center text-center">
      ...
      >
      <button class="btn btn-info w-full mt-4">
        {{ props.label }}
      </button>
      <div class="divider">
        Or login with
      </div>
      <div class="flex place-items-center items-center gap-4">
        <!-- GitHub -->
        <button class="btn btn-circle bg-black text-white border-black">
          <svg
        ...
        <!-- Google -->
        <button class="btn btn-circle bg-white text-black border-[#e5e5e5]">
          <svg
